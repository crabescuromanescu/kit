...
# Tower Submission Rules

This page contains the rules you must follow when building and submitting towers for EToH.
...
* Tower names must begin with "[Tower/Citadel/Steeple] of" before the name and must be between 1 and 4 words long ("Tower of ___ ___ ___ ___").
* The tower name and acronym must not match with another tower in-game (excluding monthly towers) and be appropriate.
